...
export const myProjects = [
  {
    ...
    desc: 'InterviewGenie is an AI-driven interview assistant leveraging Retrieval-Augmented Generation (RAG) trained on 6.8M tokens to simulate interviewer and interviewee roles. Its Streamlit-based GUI supports dynamic question generation and context-aware responses. Free Mode uses google/gemma-2b-it for basic questions, while Paid Mode utilizes o1-mini for adjustable difficulty, real-time scoring, and performance evaluation, making interview preparation seamless and efficient.',
    subdesc:
      'InterviewGenie is highly extensible, featuring custom RAG training with HuggingFace’s transformers library and smooth interaction through its Streamlit interface. Users can track progress, receive real-time feedback, and prepare effectively. Future updates include speech-to-text functionality for verbal answers, enhancing usability. Perfect for candidates and recruiters, InterviewGenie ensures smarter and more personalized interview experiences across industries.',
    href: 'https://github.com/tanaydwivedi095/InterviewGenie',
