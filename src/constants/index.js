...
export const myProjects = [
  {
    ...
    desc: 'InterviewGenie is an AI-powered interview assistant that revolutionizes interview preparation and evaluation. It uses advanced Retrieval-Augmented Generation (RAG), trained on 6.8M tokens, to simulate both interviewer and interviewee roles effectively. The system features a user-friendly Streamlit-based GUI that supports two modes: Interviewer and Interviewee. In Interviewer Mode, the Free option generates structured questions using google/gemma-2b-it, while the Paid option leverages OpenAI’s o1-mini model for difficulty-adjustable questions, real-time scoring, and aggregated performance metrics. In Interviewee Mode, users input questions and receive context-aware answers using a fine-tuned RAG pipeline. InterviewGenie provides dynamic interaction, real-time feedback, and comprehensive performance evaluation.',
    subdesc:
      'InterviewGenie stands out for its extensibility and future-ready capabilities. Users can fine-tune the RAG pipeline with custom datasets using HuggingFace’s transformers library, enabling tailored solutions for different domains. The Streamlit-based GUI ensures smooth navigation, response evaluation, and tracking of progress, including answers and scores. Future enhancements include speech-to-text functionality, allowing users to answer questions verbally for a more natural experience. With its robust architecture, InterviewGenie adapts to various industries, offering personalized feedback and actionable insights. Whether you are a job seeker refining your skills or a recruiter seeking smarter tools, InterviewGenie provides a modern, AI-driven solution.',
